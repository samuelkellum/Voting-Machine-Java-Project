...
{
	/**
	 * This program is a voting machine. It reads a user inputted text file
	 * containing candidates and their party affiliation. The program
	 * tallies votes then outputs the results to a file of the user's choosing.
	 * Additionally, if there is a winner, the program will include the name of the
	 * winner in the results. Otherwise, it will write that there is no winner.
	 *
	 */
